const SearchComponentWithUsers = () => {
    return (
        ...
        <div className="flex mt-2 flex-col items-center justify-center">
            ...
            {/* ------- 1 flex ------------ */}
            <button className="flex w-full justify-center items-center focus:bg-[#cecbd4]">
...
<div className=" flex flex-col ml-2 w-[190px]  ">
    {/* ------- 3 flex ------------ */}
    <div className=" flex ">
<p className=" ">John Leon</p>
<p className=" ml-[49px] text-[#686670] text-[15px] ">Yesterday</p>
</div>
{/* ------- 4 flex ------------ */}
<div className="flex  gap-1">
<svg className="w-3 h-3 text-blue-500 mt-1 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
  </svg>
  <p className=" text-[#686670] truncate text-[13px] w-[190px] ">Hello how are you?</p>
  </div>
  </div>
            </button>
        </>
