                            ...
                            <>
                                {noUser ? (
                                    allChats.map((value: any, index: any) => (
                                       <UserPanel key={index} onClick={() => getChatData(index)} onGetMassage={getChat} avatarUrl="https://gravatar.com/avatar/2e5178124f4966c5679f41dc9ef3129a?s=400&d=robohash&r=x" userName={value.user} lastActive='Yesterday' viewStatus={true} lastMassage='Hi how are you?' />
                                    ))
                                ) : (
                                    <div className="flex flex-col justify-center">
                                        <h1 className="w-[225px] mx-auto">You don&apos;t have chat with anyone</h1>
                                        <button type="button" onClick={() => router.push('/chat/create')} className="text-white mt-3 mx-auto bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create</button>
                                    </div>
                                )}
                            </>
                        ) : (
